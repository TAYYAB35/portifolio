export const projectsData = [
    {
        ...
        tools: ['React', 'Tailwindcss', 'SCSS', 'Text Editor', 'Express', 'Nodejs', 'MongoDB'],
        role: 'Full Stack and UI Developer',
        code: '',
        demo: 'https://topthoughts.vercel.app/',
    },
    {
        id: 1,
        name: 'BIOGROW+',
        description: "Built an organic product website in React to showcase three core solutions (Hormonal, Pest, Nutrition) using a responsive carousel. Styled with Tailwind CSS and SCSS to ensure a clean, modern UI for promoting eco-friendly, herbal-based plant care",
        tools: ['Next', 'Tailwindcss', 'SCSS', 'Transition', 'SwiperJS', 'ScrollReveal', 'Dark Mode'],
        role: 'Frontend and UI Developer',
        code: '',
        demo: 'https://herbal-shield.vercel.app/',
    },
    {
        id: 2,
        name: 'BALKE',
    ...
    },
    {
        id: 5,
        name: 'Luqta ',
        description: "Created the client side website for digicontesst",
        tools: ['Angular', 'Bootstrap', 'SCSS', 'NgZoro'],
        code: '',
        demo: 'https://digicontests.vercel.app/#/',
        role: 'UI Developer',
    },
    {
        id: 6,
